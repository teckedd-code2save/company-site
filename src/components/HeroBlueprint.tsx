...
function Tick({ cx, cy, angle, delay = 0 }: { cx: number; cy: number; angle: number; delay?: number }) {
  const len = 10;
...
export default function HeroBlueprint() {
  ...
  return (
    <div ref={ref} className="pointer-events-none absolute inset-0 z-[1] hidden lg:block" aria-hidden="true">
      {inView && (
